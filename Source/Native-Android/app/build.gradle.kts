...
android {
    namespace = "com.example.ship_journal"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.example.ship_journal"
        minSdk = 29
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("androidx.compose.ui:ui-tooling") // Tooling support
    ...
    implementation("androidx.compose.material3:material3-window-size-class") // Optional for window size class support
